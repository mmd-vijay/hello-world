...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any | Promise<any>) => import("firebase-functions/lib/cloud-functions").HttpsFunction & import("firebase-functions/lib/cloud-functions").Runnable<any>;
    };
    get tasks(): {
        /**
